...
const PATTERNS = [
  ...
  [/^La edad de un perro no puede superar los 30 años\.$/, () => "A dog's age cannot exceed 30 years."],
  [/^La edad de un gato no puede superar los 35 años\.$/, () => "A cat's age cannot exceed 35 years."],
  [/^La edad de un ave no puede superar los 100 años\.$/, () => "A bird's age cannot exceed 100 years."],
  [/^La edad de un reptil no puede superar los 100 años\.$/, () => "A reptile's age cannot exceed 100 years."],
